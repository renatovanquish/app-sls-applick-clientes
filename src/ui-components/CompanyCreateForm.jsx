...
export default function CompanyCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPhones(initialValues.phones);
    ...
    setEnableRetail(initialValues.enableRetail);
    setSchedulesSunday(initialValues.schedulesSunday);
    setCurrentSchedulesSundayValue("");
    setSchedulesMonday(initialValues.schedulesMonday);
    setCurrentSchedulesMondayValue("");
    setSchedulesTuesday(initialValues.schedulesTuesday);
    setCurrentSchedulesTuesdayValue("");
    setSchedulesWednesday(initialValues.schedulesWednesday);
    setCurrentSchedulesWednesdayValue("");
    setSchedulesThursday(initialValues.schedulesThursday);
    setCurrentSchedulesThursdayValue("");
    setSchedulesFriday(initialValues.schedulesFriday);
    setCurrentSchedulesFridayValue("");
    setSchedulesSaturday(initialValues.schedulesSaturday);
