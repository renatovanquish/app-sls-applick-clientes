...
import { createAuthorizationList } from "../graphql/mutations";
export default function AuthorizationListCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setContactNameFinished(initialValues.contactNameFinished);
    setContactPhoneFinished(initialValues.contactPhoneFinished);
    setContactEmailFinished(initialValues.contactEmailFinished);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createAuthorizationList.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AuthorizationListCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
