...
import { createDeliveryMethodOrder } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function DeliveryMethodOrderCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createDeliveryMethodOrder.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DeliveryMethodOrderCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
