...
export default function ConfigUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = configRecord
      ...
      : initialValues;
    setValidationMode(cleanValues.validationMode);
    setGoogleAnalyticsID(cleanValues.googleAnalyticsID);
    setGoogleSiteVerification(cleanValues.googleSiteVerification);
    setInviteSubject(cleanValues.inviteSubject);
    setInviteMessage(cleanValues.inviteMessage);
    setInviteSMS(cleanValues.inviteSMS);
    setFacebook(cleanValues.facebook);
    setTwitter(cleanValues.twitter);
    setInstagram(cleanValues.instagram);
    setInfoFooter(cleanValues.infoFooter);
    setMinValueOrder(cleanValues.minValueOrder);
    setPhoneOrders(cleanValues.phoneOrders);
    setAllowPayOnDelivery(cleanValues.allowPayOnDelivery);
    setAllowLocalPickup(cleanValues.allowLocalPickup);
    setDeliveryOnSunday(cleanValues.deliveryOnSunday);
    setDeliveryOnMonday(cleanValues.deliveryOnMonday);
    setDeliveryOnTuesday(cleanValues.deliveryOnTuesday);
    setDeliveryOnWednesday(cleanValues.deliveryOnWednesday);
    setDeliveryOnThursday(cleanValues.deliveryOnThursday);
    setDeliveryOnFriday(cleanValues.deliveryOnFriday);
    setDeliveryOnSaturday(cleanValues.deliveryOnSaturday);
    setDeliveryOffSunday(cleanValues.deliveryOffSunday);
    setDeliveryOffMonday(cleanValues.deliveryOffMonday);
    setDeliveryOffTuesday(cleanValues.deliveryOffTuesday);
    setDeliveryOffWednesday(cleanValues.deliveryOffWednesday);
    setDeliveryOffThursday(cleanValues.deliveryOffThursday);
    setDeliveryOffFriday(cleanValues.deliveryOffFriday);
    setDeliveryOffSaturday(cleanValues.deliveryOffSaturday);
    setShowNotesCart(cleanValues.showNotesCart);
    setNotesCart(cleanValues.notesCart);
    setSoundOnNewOrder(cleanValues.soundOnNewOrder);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          inviteSMS: inviteSMS ?? null,
          facebook: facebook ?? null,
          twitter: twitter ?? null,
          instagram: instagram ?? null,
          infoFooter: infoFooter ?? null,
          minValueOrder: minValueOrder ?? null,
          phoneOrders: phoneOrders ?? null,
          allowPayOnDelivery: allowPayOnDelivery ?? null,
          allowLocalPickup: allowLocalPickup ?? null,
          deliveryOnSunday: deliveryOnSunday ?? null,
          deliveryOnMonday: deliveryOnMonday ?? null,
          deliveryOnTuesday: deliveryOnTuesday ?? null,
          deliveryOnWednesday: deliveryOnWednesday ?? null,
          deliveryOnThursday: deliveryOnThursday ?? null,
          deliveryOnFriday: deliveryOnFriday ?? null,
          deliveryOnSaturday: deliveryOnSaturday ?? null,
          deliveryOffSunday: deliveryOffSunday ?? null,
          deliveryOffMonday: deliveryOffMonday ?? null,
          deliveryOffTuesday: deliveryOffTuesday ?? null,
          deliveryOffWednesday: deliveryOffWednesday ?? null,
          deliveryOffThursday: deliveryOffThursday ?? null,
          deliveryOffFriday: deliveryOffFriday ?? null,
          deliveryOffSaturday: deliveryOffSaturday ?? null,
          showNotesCart: showNotesCart ?? null,
          notesCart: notesCart ?? null,
          soundOnNewOrder: soundOnNewOrder ?? null,
        };
