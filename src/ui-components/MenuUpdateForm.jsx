...
export default function MenuUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setOrderDesc(cleanValues.orderDesc);
    ...
    setShowDescriptionPage(cleanValues.showDescriptionPage);
    setShowThumbnailPage(cleanValues.showThumbnailPage);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          showDescriptionPage: showDescriptionPage ?? null,
          showThumbnailPage: showThumbnailPage ?? null,
          hide: hide ?? null,
        };
