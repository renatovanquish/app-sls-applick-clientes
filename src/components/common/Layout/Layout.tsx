...
const SignUpView = dynamic(
  () => import('components/userAuth/SignUpView'), {
  loading: () => <p>...</p>,
  ssr: false,
}
)
const ConfirmCode = dynamic(
  () => import('components/userAuth/ConfirmCode'), {
  loading: () => <p>...</p>,
  ssr: false,
}
)
...
const CookiesMng = dynamic(
  () => import('components/userAuth/CookiesMng'), {
  loading: () => <p>...</p>,
  ssr: false,
}
)
...
const Layout: FC<Props> = ({ children, pageProps }) => {
  ...
  useEffect(() => {
    // const hour = moment().hour() as number
    // (hour > 20 && hour < 6) ? setTheme('dark') : setTheme('light')
    setTheme('light')
  }, [])
        ...
        >
          <div
            ...
            style={{
              ...
              maxWidth: !isSm && modalView === 'SIGNUP_VIEW' ? 1000 : 480,
            }}
          >
