  ...
  return useMemo(
    () => (
      <div
        ...
        className={cn(
          'text-accent-0 relative text-sm bg-accent-7 outline-none holver:outline-none flex items-center justify-center text-base w-full transition-colors duration-150',
          className
        )}
      >
