  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="max-w-full w-full mx-auto">
        <Segment title='Scroll Cards horizontal' description='Entre com as informações.' />
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3">
                ...
                <div className="flex">
                  ...
                  >
                    <option value="images_folder">Galeria de Mídias</option>
                    <option value="categories">Categorias do e-commerce</option>
                    <option value="category_products">Produtos de uma categoria</option>
