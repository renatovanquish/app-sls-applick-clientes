    ...
    >
      <div
        className={`flex justify-${
          content.justifyMode ? content.justifyMode : 'center'
        } flex-wrap gap-2`}
      >
        {content.data &&
          content.data.map((b: any, i: number) => (
            <button
              key={i}
              className={cn(
                `btn`,
                {
                  ['btn-primary']: b.color === 'primary',
                  ['btn-secondary']: b.color === 'secondary',
                  ['btn-accent']: b.color === 'accent',
                  ['btn-ghost']: b.color === 'ghost',
                  ['btn-link']: b.color === 'link',
                  ['btn-info']: b.color === 'info',
                  ['btn-success']: b.color === 'success',
                  ['btn-warning']: b.color === 'warning',
                  ['btn-error']: b.color === 'error',
                },
                {
                  ['btn-sm']: b.size === 'sm',
                  ['btn-md']: b.size === 'md',
