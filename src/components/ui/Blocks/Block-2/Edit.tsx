...
export default function Edit(props: Props) {
  ...
  useEffect(() => {
    if (block && block.content) {
      ...
      setValue('aspectRatio', contentParse.aspectRatio ? contentParse.aspectRatio : '1:1')
      setValue('viewShadow', contentParse.viewShadow ? contentParse.viewShadow : '-none')
      setValue('viewBorder', contentParse.viewBorder ? contentParse.viewBorder : '0')
      setValue('viewBgColor', contentParse.viewBgColor ? contentParse.viewBgColor : 'none')
      setValue(
        'viewRounded',
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="max-w-full w-full mx-auto">
        ...
        <Segment title='Imagem' description='Configurações da imagem.' />
