    ...
    <div className="m-4">
      ...
      {modalSel && (
        <Modal
          ...
          onClose={closeModal}
          focusTrap={false}
          absolute={modalSel === 'IMAGES' ? true : false}
          title={
            modalSel === 'PREVIEW' ? (
        ...
        >
          ...
          >
            {modalSel === 'PREVIEW' && (
              <div>
                {blockSel.component === '1' && <Block1 block={blockSel} />}
                {blockSel.component === '2' && <Block2 block={blockSel} />}
                {blockSel.component === '3' && <Block3 block={blockSel} />}
                {blockSel.component === '4' && <Block4 block={blockSel} />}
                {blockSel.component === '5' && <Block5 block={blockSel} />}
                {blockSel.component === '6' && <Block6 block={blockSel} />}
                {blockSel.component === '7' && <Block7 block={blockSel} />}
                {blockSel.component === '8' && <Block8 block={blockSel} />}
                {blockSel.component === '9' && <Block9 block={blockSel} />}
                {blockSel.component === '10' && <Block10 block={blockSel} />}
                {blockSel.component === '11' && <Block11 block={blockSel} />}
                {blockSel.component === '12' && <Block12 block={blockSel} />}
                {blockSel.component === '13' && <Block13 block={blockSel} />}
                {blockSel.component === '14' && <Block14 block={blockSel} />}
                {blockSel.component === '15' && <Block15 block={blockSel} />}
                {blockSel.component === '16' && <Block16 block={blockSel} />}
                {blockSel.component === '17' && <Block17 block={blockSel} />}
                {blockSel.component === '18' && <Block18 block={blockSel} />}
                {blockSel.component === '19' && <Block19 block={blockSel} />}
                {blockSel.component === '20' && <Block20 block={blockSel} />}
                {blockSel.component === '22' && <Block22 block={blockSel} />}
                {blockSel.component === '23' && <Block23 block={blockSel} />}
              </div>
            )}
            {modalSel === 'IMAGES' && (
              <div
