...
export const UIProvider: FC<Props> = (props) => {
  ...
  const setItemListSelected = (itemListSelected: any) =>
    dispatch({ type: 'SET_ITEM_LIST_SELECTED', itemListSelected })
  const setItemListMode = (itemListMode: string) =>
    dispatch({ type: 'SET_ITEM_LIST_MODE', itemListMode })
