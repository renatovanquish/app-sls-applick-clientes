...
const LoginView: FC<Props> = () => {
  ...
  const handleLogin = async (e: React.SyntheticEvent<EventTarget>) => {
    ...
    signIn(loginInput.trim(), password).then((e: any) => {
      ...
      switch (e && e.message) {
        ...
        case 'tryLoginEmail':
          setMessage('Tente fazer login informando seu email.')
          setLoading(false)
          break

        case 'tryLoginPhone':
          setMessage('Tente fazer login informando seu celular com ddd.')
          setLoading(false)
          break
  ...
  return (
    <div className="select-none px-5 md:px-10 pt-2 pb-16">
      <form
        autoComplete="off"
