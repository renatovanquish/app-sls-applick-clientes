...
const Block1 = dynamic(() => import('../../components/ui/Blocks/Block-1/View'))
const Block2 = dynamic(() => import('../../components/ui/Blocks/Block-2/View'))
// const Block3 = dynamic(() => import('../../components/ui/Blocks/Block-3/View'))
const Block4 = dynamic(() => import('../../components/ui/Blocks/Block-4/View'))
const Block5 = dynamic(() => import('../../components/ui/Blocks/Block-5/View'))
const Block6 = dynamic(() => import('../../components/ui/Blocks/Block-6/View'))
const Block7 = dynamic(() => import('../../components/ui/Blocks/Block-7/View'))
const Block8 = dynamic(() => import('../../components/ui/Blocks/Block-8/View'))
const Block9 = dynamic(() => import('../../components/ui/Blocks/Block-9/View'))
const Block10 = dynamic(
  () => import('../../components/ui/Blocks/Block-10/View')
)
const Block11 = dynamic(
  () => import('../../components/ui/Blocks/Block-11/View')
)
const Block12 = dynamic(
  () => import('../../components/ui/Blocks/Block-12/View')
)
const Block13 = dynamic(
  () => import('../../components/ui/Blocks/Block-13/View')
)
const Block14 = dynamic(
  () => import('../../components/ui/Blocks/Block-14/View')
)
const Block15 = dynamic(
  () => import('../../components/ui/Blocks/Block-15/View')
)
const Block16 = dynamic(
  () => import('../../components/ui/Blocks/Block-16/View')
)
const Block17 = dynamic(
  () => import('../../components/ui/Blocks/Block-17/View')
)
const Block18 = dynamic(
  () => import('../../components/ui/Blocks/Block-18/View')
)
const Block19 = dynamic(
  () => import('../../components/ui/Blocks/Block-19/View')
)
const Block20 = dynamic(
  () => import('../../components/ui/Blocks/Block-20/View')
)
const Block22 = dynamic(
  () => import('../../components/ui/Blocks/Block-22/View')
)
const Block23 = dynamic(
  () => import('../../components/ui/Blocks/Block-23/View')
)
...
export default function PageComponent({
  ...
  return (
    <Container>
      ...
      {false && !isSm && !isMd && <ScrollTopArrow />}
        ...
        page.blocks.items
          ...
          .map((block: any, index: number) =>
            block && block.content && block.component === '1' ? (
              <Block1 key={index} block={block} />
            ) : block && block.content && block.component === '2' ? (
              <Block2 key={index} block={block} />
            ) : block && block.content && block.component === '3' ? (
              <Block3 key={index} block={block} />
              ...
              <Block13 key={index} block={block} />
            ) : block && block.content && block.component === '14' ? (
              <Block14 key={index} block={block} />
            ) : block && block.content && block.component === '15' ? (
              <Block15 key={index} block={block} />
            ) : block && block.content && block.component === '16' ? (
              <Block16 key={index} block={block} menu={menu} />
